      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-24 text-white page-content" dir="rtl">
        ...
        <section className="mb-12" id="introduction">
          ...
          <div className="glass-panel p-6 md:p-8 rounded-2xl space-y-4 text-white/90">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li><strong>{t('pages.turkishPrivateUniversities.introduction.strengths')}</strong> {t('pages.turkishPrivateUniversities.introduction.strengthsContent')}</li>
        ...
        <section className="mb-12" id="requirements">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-semibold mb-3">{t('pages.turkishPrivateUniversities.requirements.bachelor.title')}</h3>
               <SEODataTable
            ...
            <div>
              <h3 className="text-xl font-semibold mb-3">{t('pages.turkishPrivateUniversities.requirements.master.title')}</h3>
               <SEODataTable
            ...
            <div>
              <h3 className="text-xl font-semibold mb-3">{t('pages.turkishPrivateUniversities.requirements.phd.title')}</h3>
              <SEODataTable
        ...
        <section className="mb-12" id="fees">
            ...
            />
             <div className="mt-4 text-center">
                <Link to="/ar/tuition-fees-turkey-2025" className="text-primary hover:underline">{t('pages.turkishPrivateUniversities.fees.learnMoreLink')}</Link>
            </div>
        </section>
        ...
        <section className="mb-12" id="scholarships">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 border-b-2 border-primary pb-2">{t('pages.turkishPrivateUniversities.scholarships.title')}</h2>
        ...
        <section className="mb-12" id="common-mistakes">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 border-b-2 border-primary pb-2">{t('pages.turkishPrivateUniversities.commonMistakes.title')}</h2>
        ...
        <div className="mt-12 text-center">
            ...
            <div className="flex justify-center gap-4">
                <Link to="/ar/study-in-turkey" className="text-primary hover:underline hover:text-secondary transition-colors">{t('pages.turkishPrivateUniversities.discoverMore.studyGuide')}</Link>
                <span className="text-white/40">|</span>
                <Link to="/ar/tuition-fees-turkey-2025" className="text-primary hover:underline hover:text-secondary transition-colors">{t('pages.turkishPrivateUniversities.discoverMore.tuitionFees')}</Link>
            </div>
        </div>
      </div>
